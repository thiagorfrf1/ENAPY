  ...
  initialize = function(
    ...
    ####
      ...
      add.metadata = function(merge = F) {
        ...
        meta_cols_to_use <- meta_avail[apply(self$raw[, lapply(.SD, length<-unique),
...
rsdata = r['RS.data'].head()

units = rsdata[['Condition','UserName']]
conversation = rsdata[['Condition','GroupName']]
codeCols = rsdata[['Data','Technical.Constraints','Performance.Parameters','Client.and.Consultant.Requests','Design.Reasoning','Collaboration']]
